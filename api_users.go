...
func (r ApiClustersUsersAccessGetRequest) Execute() (UserReadAccess, *APIResponse, error) {
...
func (r ApiClustersUsersGetRequest) Execute() (UserReadList, *APIResponse, error) {
